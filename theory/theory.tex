...
or the primary radiation damage it causes.
...
during the brief duration of the collision.
...
\begin{figure}[ht]
	...
	\begin{tikzpicture}[scale=2, >={Stealth[length=15pt]}]
		...
		\begin{scope}[shift={(0,-4)}]
			...
			\node at (1, 2) {\small (b) Center of mass frame};
...
velocity vector of the projectile and the target.
