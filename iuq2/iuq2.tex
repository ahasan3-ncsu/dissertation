...
% find acronym clashes

\section{Problem Definition}

% NOTE: cite kim-hofman, wachs, francine rice
The United State Department of Energy initiated the RERTR program in 1978
with the goal to develop the technology needed
...
$F_d = \num{2.31e21}$ fsn/cm$^3$,
with a life-averaged fission rate of $\num{2.3e14}$ fsn/cm$^3$/s
and a life-averaged fuel temperature of $116.3^{\circ}$ C.
In RERTR-12,
...
with life-averaged fission rate and temperature
of $\num{6.86e14}$ fsn/cm$^3$/s and $133.6^{\circ}$ C.

DART is a rate-theory based mesoscale model
capable of predicting fuel swelling behavior
based on microstructural properties of the U-Mo fuel.
However, many of the microstructural properties of U-Mo are currently unknown.
To be able to simulate fuel swelling accurately,
good estimates of the unknown properties are thus needed.
Simulations have been performed in DART
with $3,200$ different combinations of values of these properties
...
is plotted in Figure \ref{fig:mvn_expt}.
...
\begin{figure}[ht]
	\begin{subfigure}{\textwidth}
		\centering
		\caption{}
		\includegraphics[width=12cm]{iuq2/images/fuq_mvn.pdf}
	\end{subfigure}
...
At high $F_d$,
the swelling range reduces massively
