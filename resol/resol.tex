\chapter{Re-Solution of Xe Gas Bubbles
...
This threshold is often set to 10 eV
or double the cohesive energy for metals \cite{nordlund1998, duffy2006}.
...
ranging somewhere between 0.001 and 0.1.
...
Table \ref{tab:zeta} lists the parameter values for different $\zeta$.
...
\begin{figure}[ht]
	\centering
	\includegraphics[trim={2cm 2cm 2cm 2cm}, clip, height=9cm]{resol/images/3d.pdf}
	\caption{
		Xe gas bubble re-solution rate in $\gamma$U-10Mo
...
was found to be on the order of $10^{-6}$--$10^{-3}$ s$^{-1}$
