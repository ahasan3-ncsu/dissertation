...
aims to replace highly enriched uranium (HEU) fuels
in high-power research reactors with low enriched uranium (LEU) fuels.
...
offering the widest metastable $\gamma$ phase region under reactor conditions.
...
This work aims to bridge these gaps using computational methods,
