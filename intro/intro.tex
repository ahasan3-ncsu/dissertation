...
and intra- and inter-granular bubble size distributions
at various locations (bulk, grain face, grain edge, and grain corner).
The results from DART has been validated against experimental data
...
till interconnection of the bubbles occur,
