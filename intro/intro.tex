...
There exists knowledge gap in the material properties of $\gamma$U-Mo,
which limits the fuel performance evaluation.
The goal of this work is to use computational methods
to address these existing gaps
and help in engineering-scale modeling of $\gamma$U-Mo.
